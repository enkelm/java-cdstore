...
public class MainView {
	public static GridPane nextPage() {
		...
		Button button1 = new Button("User Menagement");
		gp.add(button1, 0, 0);

		Button button2 = new Button("CD Menagement");
		gp.add(button2, 0, 1);
		
		Button button3 = new Button("Generate a Bill");
		gp.add(button3, 0, 2);
		...
		button1.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent e) {
				...
				Scene scene = new Scene(UserMenagement.nextPage());
